...
public class StudentController {
    ...
    @GetMapping("/pageList")
    public ApiResult<PageUtils<Student>> pageList(@RequestParam(value = "pageNo", defaultValue = "1") Integer pageNo,
                                                  @RequestParam(value = "size", defaultValue = "10") Integer size) {
        PageUtils<Student> pageUtils = studentService.pageList(pageNo, size);
